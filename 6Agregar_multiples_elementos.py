...
# Actividad 4: Eliminar elementos de la lista

# Eliminar un elemento de la lista utilizando su nombre
...
# Eliminar un elemento de la lista utlizando su posición

# list.pop(1)

# Explique el resultado de la lista despues de cada una de las operaciones anteriores
...
# Actividad 5: Modificar elementos de la lista

# Cambie el nombre de un país de la lista  

# list[2] = 'francia'

# Muestre el resultado de la lista despues de la operación anterior
...
# Actividad 6: Agregar múltiples elementos a la lista

# Agregue varios elementos al final de la lista

list.extend(['argentina', 'brasil', 'uruguay'])

# Muestre el resultado de la lista despues de la operación anterior

print(list)

# Indique el número de elementos que tiene la lista después de agregar los nuevos elementos
